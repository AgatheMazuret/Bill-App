...
import createUser from "../containers/Login.js";
import mockLocalStorage from "./path/to/mockLocalStorage";
...
// *******************************************************************************************
  ...
  test("Si l'utilisateur n'existe pas, alors je dois créer un nouvel utilisateur", () => {
    ...
    // Utilisation de createUsers pour créer un utilisateur
  ...
  // Vérification que l'utilisateur existe dans localStorage
  const storedUser = JSON.parse(localStorage.getItem("user"));
